...
## FOR YIN, YOU MAPPED EACH NAME TO THE SAME NAME SO THAT THE REMAINDER OF THE CODE STAYS CONSISTENT WITH THE NON-YIN VERSION
reviewer_map = {
    'Yin Man': 'Yin Man',
    'Pauline Dong': 'Pauline Dong',
    'Lucia Kim': 'Lucia Kim',
    'Jennifer Carroll': 'Jennifer Carroll',
    'Maxine Armstrong': 'Maxine Armstrong',
    'Vanessa Coffey': 'Vanessa Coffey',
    'Malika Ladha': 'Malika Ladha',
    'Vivien Fong': 'Vivien Fong',
    'Jehan Lalani Carbone': 'Jehan Lalani Carbone',
    'Danielle Anthony': 'Danielle Anthony',
    'Peter Yoo': 'Peter Yoo',
    'Tommy Lam': 'Tommy Lam',
    'Lucy Liu': 'Lucy Liu',
    'Emily Ahola': 'Emily Ahola',
    'Hanae Mohamed': 'Hanae Mohamed',
    'Andrei Rotarus': 'Andrei Rotarus',
    'Crystal Chui': 'Crystal Chui',
    'Alan Lu': 'Alan Lu',
    'Arthur Zych': 'Arthur Zych',
    'Ghazaleh EA': 'Ghazaleh EA',
    'Elyanna Penafiel': 'Elyanna Penafiel',
    'Pete Quinn': 'Pete Quinn',
    'Lara Said': 'Lara Said',
    'Ken Ruan': 'Ken Ruan',
    'Kate Lam': 'Kate Lam'
}
...
if __name__ == '__main__':
  app.run_server(debug=True, port=os.environ.get('PORT', 8080))#for aws app runner
